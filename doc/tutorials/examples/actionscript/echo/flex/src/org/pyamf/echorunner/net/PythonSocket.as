package org.pyamf.echorunner.net
{
	...
	import org.pyamf.echorunner.messages.LogEvent;
	...
	public class PythonSocket extends Socket
	{
	    ...
	    private function logger(msg:String):void
		{
			...
			var logEvent:LogEvent = new LogEvent( LOG_UPDATE, msg );
			dispatchEvent( logEvent );
		}
		
	    private function connectHandler(event:Event):void 
	    {
	    	var message:String = _log + "Connected to server.\n";
	    	var logEvent:LogEvent = new LogEvent( LOG_UPDATE, message);
			dispatchEvent( logEvent );
